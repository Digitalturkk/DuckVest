...
public interface InvestorService {
    ...
    InvestorAccountDTO getInvestorAccountInformation(Long id, int portfolioId); // We use int here because we have list of portfolios, so we need to get it by its index
 }
